...
# Specify the path to the new JSON file with flavors
...
# Search function to filter flavors based on a query in the title
def json_search(query):
    ...
    # Select only the columns you want to return in the JSON response
