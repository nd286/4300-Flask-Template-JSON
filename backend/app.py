...
for doc in docs:
    ...
    if t not in unique_flavors:
        ...
        unique_flavors[t]["text"] += " "+doc.get("text","")
...
ALLERGY_KEYWORDS={"dairy":["milk","cream","cheese","butter","whey","casein","yogurt","skim milk"],"nuts":["peanut","almond","cashew","walnut","hazelnut","macadamia","pecan","pistachio","nut","peanus","almonds","cashews","walnuts","hazelnuts","macadamias","pecans","pistachios","nuts"],"gluten":["wheat","barley","rye","spelt","farro","malt"],"soy":["soy","soya","soybean","edamame","tofu"],"eggs":["egg","egg yolk","egg white","albumin","eggs","egg yolks","egg whites","albumins"]}
